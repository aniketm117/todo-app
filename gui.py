...
img_size_1 = (20, 20)  # add icon size
img_size_2 = (50, 50)  # edit, complete, exit icon size
...
add_button = sg.Button(size=2, image_source="icons8-add-50.png",
                       tooltip="Add To-do Item", key="Add",
